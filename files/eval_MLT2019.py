...
tf.app.flags.DEFINE_string('test_data_list', '../data/MLT_test/test.txt', '')
...
def get_images():
    files = []
    im_list = [l.strip() for l in open(FLAGS.test_data_list).readlines()]
    dirname = os.path.dirname(FLAGS.test_data_list)
